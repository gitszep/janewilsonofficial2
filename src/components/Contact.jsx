    ...
    <section className='section bg-primary' id="contact">
        <div className="container mx-auto">
            <div className="flex flex-col items-center text-center">
                ...
                before:-top-7 before:-left-40 before:hidden before:lg:block'>Contact me</h2>
                <p className='subtitle'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptate enim illum ab debitis fugiat repellendus illo, cumque repudiandae ipsa quasi.</p>
            </div>
